...
// Azure IoT
#define IOT_CONFIG_IOTHUB_FQDN "abacusdev.azure-devices.net"
#define IOT_CONFIG_DEVICE_ID "AbacusSingleHome"
String AZURE_SUB_TOPIC = "devices/" + String(IOT_CONFIG_DEVICE_ID) + "/messages/devicebound/%24.to=%2Fdevices%2F" + String(IOT_CONFIG_DEVICE_ID) + "%2Fmessages%2FdeviceBound&%24.ct=application%";
// Use device key if not using certificates
#ifndef IOT_CONFIG_USE_X509_CERT
#define IOT_CONFIG_DEVICE_KEY "olCta65vTjOsMM81DcYAzBA+UwEpR9OKJDiGEDUBlkk="
#endif // IOT_CONFIG_USE_X509_CERT
